...
<?php }   ?>
        <p class="width3 floatleft" id="com-form-login-username">
        ...
        <p class="width3 floatleft" id="com-form-login-password">
        ...
        <div class="width3 floatleft">
            ...
            <input class="floatleft" type="checkbox" id="remember" name="remember" class="inputbox" value="yes" alt="Remember Me" />
            <label class="floatleft" for="remember"><?php echo $remember_me = JVM_VERSION===1? JText::_('Remember me') : JText::_('JGLOBAL_REMEMBER_ME') ?></label>
            <?php endif; ?>
        </div>
